...
---@return number
function m:GetSexagenaryYear(time) end

---@param sexagenaryYear number
---@return number
function m:GetCelestialStem(sexagenaryYear) end

---@param sexagenaryYear number
---@return number
function m:GetTerrestrialBranch(sexagenaryYear) end
...
System.Globalization.EastAsianLunisolarCalendar = m
return m
