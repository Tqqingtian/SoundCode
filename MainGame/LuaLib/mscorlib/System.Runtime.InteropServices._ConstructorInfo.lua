---@class System.Runtime.InteropServices._ConstructorInfo : table
...
---@return any
function m:Invoke_5(parameters) end

---@abstract
---@param obj any
---@param parameters any[]
---@return any
function m:Invoke_3(obj, parameters) end
...
---@return any
function m:Invoke_4(invokeAttr, binder, parameters, culture) end
...
---@param culture System.Globalization.CultureInfo
---@return any
function m:Invoke_2(obj, invokeAttr, binder, parameters, culture) end
...
System.Runtime.InteropServices._ConstructorInfo = m
return m
