---@class Unity.Jobs.IJobExtensions.JobStruct_1.ExecuteJobFunction_T_ : System.MulticastDelegate
local m = {}
...
Unity.Jobs.IJobExtensions.JobStruct_1.ExecuteJobFunction_T_ = m
return m
