    ...
    public class SocketTcpRoutime 
    {
        ...
        private void ConnectCallBack(IAsyncResult ar)
        {
            ...
            if (m_Client.Connected)
            {
                ...
                GameEntry.Socket.RegisterSocketTcpRoutime(this);
        ...
        public void DisConnect()
        {
            if (m_Client != null && m_Client.Connected)
            {
                ...
                m_Client.Close();
                GameEntry.Socket.RemoveSocketTcpRoutime(this);
            }
        }
        #endregion
