...
namespace TQ
{
    ...
    public class PoolComponentInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(10);
            //绘制滑动条 释放资源池间隔
            ReleaseResourceInterval.intValue = 60;

            int releaseAssetBundleInterval = (int)EditorGUILayout.Slider("释放AssetBundle池间隔", ReleaseResourceInterval.intValue, 10, 1800);
            ...
            if (releaseAssetInterval != ReleaseResourceInterval.intValue)
            {
