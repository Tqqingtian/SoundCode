...
namespace PathologicalGames
{
    ...
    public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
        ...
        /// </summary>
        public Transform Spawn(Transform prefab, Vector3 pos, Quaternion rot, object resourceEntity = null)
        {
            Transform inst = this.Spawn(prefab, pos, rot, null, resourceEntity);
