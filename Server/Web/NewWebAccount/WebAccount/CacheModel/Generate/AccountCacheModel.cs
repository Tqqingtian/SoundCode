/// <summary>
/// 类名 : AccountCacheModel
/// 作者 : 北京-边涯
/// 说明 : 
/// 创建日期 : 2016-05-10 22:33:00
/// </summary>
using System;
...
/// CacheModel
/// </summary>
public partial class AccountCacheModel : MFAbstractCacheModel
{
    #region AccountCacheModel 私有构造
    /// <summary>
    /// 私有构造
    /// </summary>
    private AccountCacheModel()
    {
    ...
    private static AccountCacheModel instance = null;
    public static AccountCacheModel Instance
    {
        get
        {
            if (instance == null)
            {
                lock (lock_object)
                {
                    if (instance == null)
                    {
                        instance = new AccountCacheModel();
                    }
                }
            }
            return instance;
    ...
    /// 数据模型层单例
    /// </summary>
    private AccountDBModel DBModel { get { return AccountDBModel.Instance; } }
    #endregion
    ...
    /// <returns></returns>
    public MFReturnValue<object> Create(AccountEntity entity)
    {
    ...
    /// <param name="entity"></param>
    /// <returns></returns>
    public MFReturnValue<object> Update(AccountEntity entity)
    {
    ...
    /// <returns></returns>
    public AccountEntity GetEntity(string condition, bool isAutoStatus = true)
    {
    ...
    /// <returns></returns>
    public List<AccountEntity> GetList(string tableName = "", string columns = "*", string condition = "", string orderby = "Id", bool isDesc = true, bool isAutoStatus = true, bool isEfficient = false)
    {
    ...
    /// <param name="isEfficient"></param>
    /// <returns></returns>
    public MFReturnValue<List<AccountEntity>> GetPageList(string tableName = "", string columns = "*", string condition = "", string orderby = "Id", bool isDesc = true, int? pageSize = 20, int? pageIndex = 1, bool isAutoStatus = true, bool isEfficient = false)
    {
