...
public partial class ChannelDBModel : MFAbstractSQLDBModel<ChannelEntity>
{
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "ChannelId", "InnerVersion", "SourceVersion", "SourceUrl", "RechargeUrl", "TDAppId", "IsOpenTD", "PayServerNo", "ChannelStatus" };
            }
            return _ColumnList;
        }
    }
    ...
    protected override SqlParameter[] ValueParas(ChannelEntity entity)
    {
        SqlParameter[] parameters = new SqlParameter[] {
                ...
                new SqlParameter("@SourceVersion", entity.SourceVersion) { DbType = DbType.String },
        ...
        foreach (DataRow row in table.Rows)
        {
            ...
            switch (colName.ToLower())
            {
                ...
                case "innerversion":
                    ...
                    break;
                case "sourceversion":
                    if (!(reader["SourceVersion"] is DBNull))
                        entity.SourceVersion = Convert.ToString(reader["SourceVersion"]);
                    break;
                case "sourceurl":
