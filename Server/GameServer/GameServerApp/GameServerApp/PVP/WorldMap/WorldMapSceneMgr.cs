...
namespace GameServerApp.PVP.WorldMap
{
    ...
    public class WorldMapSceneMgr : Singleton<WorldMapSceneMgr>, IDisposable
    {
        ...
        #region InitWorldMapScene 初始化世界地图场景控制器
        /// <summary>
        /// 初始化世界地图场景控制器
        /// </summary>
        ...
        private void OnWorldMapCurrRoleUseSkill(Role role, byte[] buffer)
        {
            ...
            WorldMap_CurrRoleUseSkillProto proto = WorldMap_CurrRoleUseSkillProto.GetProto(role.SocketReceiveMS, buffer);
            ...
            for (int i = 0; i < beAttackCount; i++)
            {
                ...
                //攻击者的MP要减少
                SkillLevelEntity skillLevelEntity = DataTableManager.Instance.SkillLevelDBModel.GetEntityBySkillIdAndLevel(skillId, skillLevel);
        ...
        private void CalculateHurtValue(Role currRole, Role enemy, int skillId, int skillLevel, ref bool isCri, ref int hurtValue)
        {
            ...
            SkillEntity skillEntity = DataTableManager.Instance.SkillDBModel.Get(skillId);
            SkillLevelEntity skillLevelEntity = DataTableManager.Instance.SkillLevelDBModel.GetEntityBySkillIdAndLevel(skillId, skillLevel);
