...
namespace GameServerApp.Controller
{
    public class RoleController : Singleton<RoleController>, IDisposable
    {
        ...
        private void OnSystemHeartbeat(Role role, byte[] buffer)
        {
            System_HeartbeatProto proto = System_HeartbeatProto.GetProto(role.SocketReceiveMS, buffer);
            float localTime = proto.LocalTime;

            SystemHeartbeatReturn(role, localTime);
        }
        ...
        private void SystemHeartbeatReturn(Role role, float localTime)
        {
        ...
        private void LogOnGameServerReturn(Role role, int accountId)
        {
            ...
            //Role_ListTestProto proto2 = new Role_ListTestProto();
            //proto2.RoleType = 221;

            //proto2.CurrRole.RoleId = 1001;
            //proto2.CurrRole.RoleName = "Test1001";

            //proto2.RoleList = new List<Role_DataProto>();
            //proto2.RoleList.Add(new Role_DataProto() { RoleId = 2002, RoleName = "妈卖批" });

            //proto2.RoleList.Add(new Role_DataProto() { RoleId = 2003, RoleName = "神经" });
            //for (int i = 0; i < proto2.RoleList.Count; i++)
            //{
            //    Console.WriteLine(proto2.RoleList[i].RoleName);
            //}
            ////给客户端发消息
            //role.Client_Socket.SendMsg(proto2.ToArray(role.SocketSendMS));
        }
        #endregion
        ...
        {
            RoleOperation_CreateRoleProto proto = RoleOperation_CreateRoleProto.GetProto(role.SocketReceiveMS, buffer);

            Console.Write("创建角色"+ proto.JobId+"昵称：" + proto.RoleNickName);
            //把角色信息添加到数据库
            ...
            //给角色战斗相关的属性赋值
            //职业 等级
            JobEntity jobEntity = DataTableManager.Instance.JobDBModel.Get(entity.JobId);

            //职业等级数据
            JobLevelEntity jobLevelEntity = DataTableManager.Instance.JobLevelDBModel.Get(entity.Level);
            ...
            entity.AttackNumber = jobEntity.AttackNumber;
            entity.StrikePower = jobEntity.StrikePower;
            entity.PiercingPower = jobEntity.PiercingPower;
            entity.MagicPower = jobEntity.MagicPower;
            entity.ChoppingDefense = jobEntity.ChoppingDefense;
            ...
            if (count == 0)
            {
                ...
                role.ToSpeed = entity.ToSpeed;
                role.WeaponDamageMin = entity.WeaponDamageMin;
                role.WeaponDamageMax = entity.WeaponDamageMax;
                role.AttackNumber = entity.AttackNumber;
                role.StrikePower = entity.StrikePower;
                role.PiercingPower = entity.PiercingPower;
                role.MagicPower = entity.MagicPower;
                role.ChoppingDefense = entity.ChoppingDefense;
                role.PuncturDefense = entity.PuncturDefense;
                role.MagicDefense = entity.MagicDefense;
        ...
        {
            RoleOperation_DeleteRoleProto proto = RoleOperation_DeleteRoleProto.GetProto(role.SocketReceiveMS, buffer);
            //删除角色
        ...
        private void OnSelectRoleInfoReturn(Role role)
        {
            ...
            if (entity != null)
            {
                ...
                proto.ToSpeed = entity.ToSpeed;
                proto.WeaponDamageMin = entity.WeaponDamageMin;
                proto.WeaponDamageMax = entity.WeaponDamageMax;
                proto.AttackNumber = entity.AttackNumber;
                proto.StrikePower = entity.StrikePower;
                proto.PiercingPower = entity.PiercingPower;
                proto.MagicPower = entity.MagicPower;
                proto.ChoppingDefense = entity.ChoppingDefense;
                proto.PuncturDefense = entity.PuncturDefense;
                proto.MagicDefense = entity.MagicDefense;
        ...
        {
            //根据需要 验证体力 等信息
            GameLevel_EnterProto proto = GameLevel_EnterProto.GetProto(role.SocketReceiveMS, buffer);
            ...
            role.Client_Socket.SendMsg(retProto.ToArray(role.SocketSendMS));
        }
        #endregion
        ...
        {
            GameLevel_VictoryProto proto = GameLevel_VictoryProto.GetProto(role.SocketReceiveMS, buffer);
        ...
        {
            //根据需要 验证体力 等信息
            GameLevel_FailProto proto = GameLevel_FailProto.GetProto(role.SocketReceiveMS, buffer);
        ...
        {
            WorldMap_RoleEnterProto proto = WorldMap_RoleEnterProto.GetProto(role.SocketReceiveMS, buffer);
        ...
        {
            WorldMap_PosProto proto = WorldMap_PosProto.GetProto(role.SocketReceiveMS, buffer);
        ...
        private void OnTaskSearchTask(Role role, byte[] buffer)
        {
            ...
            proto.CurrTaskItemList.Add(new Task_SearchTaskReturnProto.TaskItem() { Id = 1001, Status = 0 });
            proto.CurrTaskItemList.Add(new Task_SearchTaskReturnProto.TaskItem() { Id = 1002, Status = 1 });
            proto.CurrTaskItemList.Add(new Task_SearchTaskReturnProto.TaskItem() { Id = 1003, Status = 2 });
            proto.CurrTaskItemList.Add(new Task_SearchTaskReturnProto.TaskItem() { Id = 1004, Status = 0 });
            proto.CurrTaskItemList.Add(new Task_SearchTaskReturnProto.TaskItem() { Id = 1005, Status = 1 });
        ...
        {
            Shop_BuyProductProto proto = Shop_BuyProductProto.GetProto(role.SocketReceiveMS, buffer);
        ...
        private void OnShopBuyProductReturn(Role role, int productId)
        {
            ...
            ShopEntity entity = DataTableManager.Instance.ShopDBModel.Get(productId);
            if (entity == null)
            {
                hasError = true;
                msgCode = 102007;
        ...
        {
            Goods_SearchEquipDetailProto proto = Goods_SearchEquipDetailProto.GetProto(role.SocketReceiveMS, buffer);
        ...
        {
            Goods_SellToSysProto proto = Goods_SellToSysProto.GetProto(role.SocketReceiveMS, buffer);
        ...
        {
            Goods_UseItemProto proto = Goods_UseItemProto.GetProto(role.SocketReceiveMS, buffer);
        ...
        {
            Goods_EquipPutProto proto = Goods_EquipPutProto.GetProto(role.SocketReceiveMS, buffer);
        ...
        public override void Dispose()
        {
            #region 系统相关
            //客户端发送登录区服消息
            EventDispatcher.Instance.RemoveEventListener(ProtoCodeDef.System_Heartbeat, OnSystemHeartbeat);
            #endregion
