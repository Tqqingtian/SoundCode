...
public partial class RoleDBModel : MFAbstractSQLDBModel<RoleEntity>
{
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "AccountId", "JobId", "NickName", "Level", "Exp", "TotalRechargeMoney",
                    "Money", "Gold", "MaxHP", "MaxMP", "CurrHP", "CurrMP", "ToSpeed", "WeaponDamageMin", "WeaponDamageMax", "AttackNumber",
                    "StrikePower", "PiercingPower", "MagicPower", "ChoppingDefense", "PuncturDefense", "MagicDefense", "LastPassGameLevelId",
                    "LastInWorldMapId", "LastInWorldMapPos", "CreateTime", "UpdateTime", "Equip_Weapon", "Equip_Pants", "Equip_Clothes", "Equip_Belt",
                    "Equip_Cuff", "Equip_Necklace", "Equip_Shoe", "Equip_Ring" };
            }
            return _ColumnList;
        }
    }
